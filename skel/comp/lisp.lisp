...
(defmethods read-ast 
  (((self sk-lisp-component) stream) (setf (ast self) (read-lisp-until-end stream)) self)
  (((self sk-lisp-component) (stream pathname)) (setf (ast self) (read-lisp-file stream)) self))
