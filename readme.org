...
- [[https://compiler.company/docs/core][Docs]]
  - [[https://compiler.company/docs/core/install.html][Install]] :: Install Guide
  - [[https://compiler.company/docs/core/tests.html][Tests]] :: Testing Guide
  - [[https://compiler.company/docs/core/stats.html][Stats]] :: Project Statistics
...
#+RESULTS:
#+begin_example
skel v0.1.1:0e043dcda8f4+ --- A hacker's project compiler.
...
#+RESULTS:
#+begin_example
#:debug 0.44; (#S(CLI-NODE :KIND OPT :FORM #<CLI-OPT help :global T :val T>))
...
commands:
  show 
#:debug 0.453333; /home/ellis/comp/core
