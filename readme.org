...
Quicklisp installed, you can execute =./x.lisp= which will generate
the core build tool binary - =./x=. This tool is a convenience for
building and testing different parts of the core.
...
Calling =x= with no arguments drops into a REPL:
...
#+begin_src shell :results output :noeval t :exports both
# test systems
./x test std
#+end_src
...
To save the prelude core to =.stash/prelude.core=:
...
** COMMENT alik                                                        :rust:
#+begin_src shell :results output :exports both
cd rust && cargo run --bin alik -- --help
#+end_src
...
** krypt                                                               :rust:
#+begin_src shell :results output :exports both
cd rust && cargo run --bin krypt -- --help
#+end_src
...
** mailman                                                             :rust:
#+begin_src shell :results output :exports both
cd rust && cargo run --bin mailman -- --help
#+end_src
...
* Emacs
The core contains some Emacs Lisp libraries under =emacs= which may be
installed for the current user using the corresponding Makefile.
