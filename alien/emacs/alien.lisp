;;; emacs/alien.lisp --- Emacs Alien Types
...
(define-alien-type emacs-value-frame
    (struct emacs-value-frame
      (objects (array (struct emacs-value-tag) #.+emacs-value-frame-size+))
      (offset int)
...
(define-alien-type emacs-env-32
    (struct emacs-env-32
      (size size-t)
      (private-members (* (struct emacs-env-private)))
      ;; fns
      (make-global-ref (* t))
      (free-global-ref (* t))
...
(define-alien-type emacs-runtime-private
  (struct emacs-runtime-private
    (env (* (struct emacs-env-32)))))

(define-alien-type emacs-runtime
  (struct emacs-runtime
    (size size-t)
    (private-members (* emacs-runtime-private))
    (get-environment (* (function (* t) (* t))))))
