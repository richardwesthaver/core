...
((:integer ioring-file-index-alloc "IORING_FILE_INDEX_ALLOC")
 ...
 (:integer ioring-cqe-f-buf-more "IORING_CQE_F_BUF_MORE")
 (:integer ioring-cqe-f-skip "IORING_CQE_F_SKIP")
 (:integer ioring-cqe-f-32 "IORING_CQE_F_32")
 ...
 (:enum ioring-zcrx-area-flags ((ioring-zcrx-area-dmabuf "IORING_ZCRX_AREA_DMABUF")))
 (:enum zcrx-reg-flags ((zcrx-reg-import "ZCRX_REG_IMPORT")))
 ;; (:enum zcrx-features ((zcrx-feature-rx-page-size "ZCRX_FEATURE_RX_PAGE_SIZE")))
 (:enum zcrx-ctr-op ((zcrx-ctrl-flush-rq "ZCRX_CTRL_FLUSH_RQ")
                     (zcrx-ctrl-export "ZCRX_CTRL_EXPORT")
                     (__zcrx-ctrl-last "__ZCRX_CTRL_LAST"))))
