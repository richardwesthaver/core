...
(;; signals
 ...
 (:integer so-zerocopy "SO_ZEROCOPY")
 ;; tcp
 ...
 (:integer tcp-mss "TCP_MSS")
 (:integer tcp-maxwin "TCP_MAXWIN")
 (:integer tcp-max-winshift "TCP_MAX_WINSHIFT")
 (:integer tcpi-opt-timestamps "TCPI_OPT_TIMESTAMPS")
 (:integer tcpi-opt-sack "TCPI_OPT_SACK")
 (:integer tcpi-opt-wscale "TCPI_OPT_WSCALE")
 (:integer tcpi-opt-ecn "TCPI_OPT_ECN")
 (:integer tcpi-opt-ecn-seen "TCPI_OPT_ECN_SEEN")
 (:integer tcpi-opt-syn-data "TCPI_OPT_SYN_DATA")
 (:integer tcpi-opt-usec-ts "TCPI_OPT_USEC_TS")
 (:integer tcpi-opt-tfo-child "TCPI_OPT_TFO_CHILD")
 (:integer tcp-md5sig-maxkeylen "TCP_MD5SIG_MAXKEYLEN")
 (:integer tcp-md5sig-flag-prefix "TCP_MD5SIG_FLAG_PREFIX")
 (:integer tcp-md5sig-flag-ifindex "TCP_MD5SIG_FLAG_IFINDEX")
 (:integer tcp-zerocopy-receive "TCP_ZEROCOPY_RECEIVE")
 ;; ip
