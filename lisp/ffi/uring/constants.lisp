...
(
 ...
 (:enum io-uring-op
        (
         (ioring-op-nop "IORING_OP_NOP")
         (ioring-op-ready "IORING_OP_READV")
         (ioring-op-writev "IORING_OP_WRITEV")
         (ioring-op-fsync "IORING_OP_FSYNC")
         (ioring-op-read-fixed "IORING_OP_READ_FIXED")
         (ioring-op-write-fixed "IORING_OP_WRITE_FIXED")
         (ioring-op-poll-add "IORING_OP_POLL_ADD")
         (ioring-op-poll-remove "IORING_OP_POLL_REMOVE")
         (ioring-op-sync-file-range "IORING_OP_SYNC_FILE_RANGE")
         (ioring-op-sendmsg "IORING_OP_SENDMSG")
         (ioring-op-recvmsg "IORING_OP_RECVMSG")
         (ioring-op-timeout "IORING_OP_TIMEOUT")
         (ioring-op-timeout-remove "IORING_OP_TIMEOUT_REMOVE")
         (ioring-op-accept "IORING_OP_ACCEPT")
         (ioring-op-async-cancel "IORING_OP_ASYNC_CANCEL")
         (ioring-op-link-timeout "IORING_OP_LINK_TIMEOUT")
         (ioring-op-connect "IORING_OP_CONNECT")
         (ioring-op-fallocate "IORING_OP_FALLOCATE")
         (ioring-op-openat "IORING_OP_OPENAT")
         (ioring-op-close "IORING_OP_CLOSE")
         (ioring-op-files-update "IORING_OP_FILES_UPDATE")
         (ioring-op-statx "IORING_OP_STATX")
         (ioring-op-read "IORING_OP_READ")
         (ioring-op-write "IORING_OP_WRITE")
         (ioring-op-fadvise "IORING_OP_FADVISE")
         (ioring-op-madvise "IORING_OP_MADVISE")
         (ioring-op-send "IORING_OP_SEND")
         (ioring-op-recv "IORING_OP_RECV")
         (ioring-op-openat2 "IORING_OP_OPENAT2")
         (ioring-op-epoll-ctl "IORING_OP_EPOLL_CTL")
         (ioring-op-splice "IORING_OP_SPLICE")
         (ioring-op-provide-buffers "IORING_OP_PROVIDE_BUFFERS")
         (ioring-op-remove-buffers "IORING_OP_REMOVE_BUFFERS")
         (ioring-op-tee "IORING_OP_TEE")
         (ioring-op-shutdown "IORING_OP_SHUTDOWN")
         (ioring-op-renameat "IORING_OP_RENAMEAT")
         (ioring-op-unlinkat "IORING_OP_UNLINKAT")
         (ioring-op-mkdirat "IORING_OP_MKDIRAT")
         (ioring-op-symlinkat "IORING_OP_SYMLINKAT")
         (ioring-op-linkat "IORING_OP_LINKAT")
         (ioring-op-msg-ring "IORING_OP_MSG_RING")
         (ioring-op-fsetxattr "IORING_OP_FSETXATTR")
         (ioring-op-setxattr "IORING_OP_SETXATTR")
         (ioring-op-fgetxattr "IORING_OP_FGETXATTR")
         (ioring-op-getxattr "IORING_OP_GETXATTR")
         (ioring-op-socket "IORING_OP_SOCKET")
