...
((:integer +tree-sitter-language-version+ "TREE_SITTER_LANGUAGE_VERSION" t t)
 ...
 (:integer +ts-builtin-sym-error+ "ts_builtin_sym_error" t t)
 (:integer +ts-builtin-sym-end+ "ts_builtin_sym_end" t t)
 (:integer +tree-sitter-serialization-buffer-size+ "TREE_SITTER_SERIALIZATION_BUFFER_SIZE" t t))
