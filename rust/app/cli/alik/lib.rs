...
use net::{http::tower::trace::TraceLayer, reqwest::Client, stream::StreamExt};
...
pub async fn proxy_via_reqwest(State(client): State<Client>) -> Response {
  ...
  // Here the mapping of headers is required due to reqwest and axum differ on
  // the http crate versions
