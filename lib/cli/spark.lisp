...
(defityped spark ((numbers list) &key min max key) string
  "Generate a sparkline string for a list of real numbers.
...
(defvar *vticks*
  ...
  "
A simple-vector of characters for representation of vertical
...
(definline vspark (numbers &key min max key (size 50) labels title (scale? t) (newline? t))
"Generate a vertical sparkline string for a list of real numbers.
