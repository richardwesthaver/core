...
(defparameter *operator-assoc-table* '((* math/sym:*)
                                       (.* math/sym:.*)
                                       (@ math/sym:@)
                                       (⊗ math/sym:⊗)
                                       (+ math/sym:+)
                                       ...
                                       (^ math/sym:expt)
                                       (.^ math/sym:expt)
                                       (sin math/sym:sin) (cos math/sym:cos) (tan math/sym:tan) (asin math/sym:asin) (acos math/sym:acos) (atan math/sym:atan) (exp math/sym:exp) (log math/sym:log) (expt math/sym:expt)
                                       (sinh math/sym:sinh) (cosh math/sym:cosh) (tanh math/sym:tanh) (asinh math/sym:asinh) (acosh math/sym:acosh) (atanh math/sym:atanh)
...
(defun infix-reader (stream subchar arg)
  ...
  (letv* ((iexpr bind (token-reader stream (ecase (read-char stream t nil t) (#\( (cons #\( #\))) (#\[ (cons #\[ #\])) (#\" (cons #\" #\")))))
