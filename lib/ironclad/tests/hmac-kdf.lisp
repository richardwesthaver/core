...
(deftest hmac-kdf-2 ()
    (run-kdf-test (crypto:make-kdf 'crypto:hmac-kdf
                  ...
                  (ironclad:hex-string-to-byte-array "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f404142434445464748494a4b4c4d4e4f")
                  (ironclad:hex-string-to-byte-array "606162636465666768696a6b6c6d6e6f707172737475767778797a7b7c7d7e7f808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9fa0a1a2a3a4a5a6a7a8a9aaabacadaeaf")
                  0
                  82
...
(deftest hmac-kdf-3 ()
    (run-kdf-test (crypto:make-kdf 'crypto:hmac-kdf
                  ...
                  0
                  42
                  (ironclad:hex-string-to-byte-array "8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d9d201395faa4b61a96c8"))
  t)
...
(deftest hmac-kdf-4 ()
    (run-kdf-test (crypto:make-kdf 'crypto:hmac-kdf
                                   :digest :sha1
                                   :additional-data (ironclad:hex-string-to-byte-array "f0f1f2f3f4f5f6f7f8f9"))
                  (ironclad:hex-string-to-byte-array "0b0b0b0b0b0b0b0b0b0b0b")
                  (ironclad:hex-string-to-byte-array "000102030405060708090a0b0c")
                  0
                  42
...
(deftest hmac-kdf-7 ()
    (run-kdf-test (crypto:make-kdf 'crypto:hmac-kdf
                  ...
                  0
                  42
                  (ironclad:hex-string-to-byte-array "2c91117204d745f3500d636a62f64f0ab3bae548aa53d423b0d1f27ebba6f5e5673a081d70cce7acfc48"))
  t)
