...
(defverb names (self)
  ...
  (:method ((self list))
    (mapcar 'name self))
  (:method ((self vector))
    (map 'vector 'name self))
  (:method ((self hash-table))
    (std/hash:hash-table-keys self))
  (:documentation "Return the name of each element in collection SELF."))
(defverb flush (self &key)
  (:documentation "Flush an object."))
(defverb description (self)
  (:accessor t)
  (:documentation "Return the description of SELF."))
...
(defverb stat (self &key)
  (:documentation "Return a status message or statistic value based on supplied args."))
(defverb tags (self)
  (:accessor t)
...
(defverb execute (self obj &key)
  ...
  (:method ((self null) obj &key &allow-other-keys) (funcall obj)))
...
(defverb properties (self)
  (:accessor t)
  (:documentation "Access the properties of object SELF."))
(defverb props (self)
  (:accessor t)
  (:documentation "Access the props of object SELF. May be used as a short-hand for PROPERTIES."))
(defverb prop (self key)
  (:accessor t)
  (:documentation "Access the property KEY of object SELF."))
...
(defverb metadata (self &key)
  (:accessor t)
  (:documentation "Access the metadata of object SELF."))
(defverb bind (self)
  (:accessor t)
