...
(macrolet ((blas9 (sym type)
  ...
  (blasfunc snorm int (uplo char :copy) (n int :copy) (alpha int :copy) (x (* float)) (incx int :copy))
  (blasfunc dnorm int (uplo char :copy) (n int :copy) (alpha int :copy) (x (* double)) (incx int :copy))
  (blasfunc cnorm int (uplo char :copy) (n int :copy) (alpha int :copy) (x (* float)) (incx int :copy))
  (blasfunc znorm int (uplo char :copy) (n int :copy) (alpha int :copy) (x (* double)) (incx int :copy))
  (blas13 sgbmv float)
  (blas13 dgbmv double)
