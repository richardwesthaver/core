...
(macrolet ((lap6 (sym type)
  ...
  (lap6* ztrti double)
  (lap6* xtrti xdouble)
  (blasfunc slamch float (cmach char :copy))
  (blasfunc dlamch double (cmach char :copy))
  (blasfunc qlamch xdouble (cmach char :copy))
  (blasfunc slamc3 float (a float :copy) (b float :copy))
  (blasfunc dlamc3 double (a double :copy) (b double :copy))
  (blasfunc qlamc3 xdouble (a xdouble :copy) (b xdouble :copy)))
