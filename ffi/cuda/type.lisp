...
(define-alien-enum (cu-event-flag)
  :default 0
  :blocking-sync 1
  :disable-timing 2
  :interprocess 4)

(define-alien-enum (cu-stream-flag)
  :default 0
  :non-blocking 1)

(define-alien-enum (cu-memhostalloc-flag)
  :portable 1
  :devicemap 2
  :writecombined 4)

(define-alien-enum (cu-memhostregister-flag)
  :portable 1
  :devicemap 2
  :iomemory 4
  :read-only 8)

(define-alien-enum (cu-result)
