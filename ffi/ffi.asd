...
(defsystem :ffi/tests
  :depends-on 
  (:arrow/tests :blake3/tests :btrfs/tests :matroska/tests
   :cuda/tests :evdev/tests :glib/tests :gstreamer/tests
   :keyutils/tests :rocksdb/tests :alsa/tests :sndfile/tests 
   :ssh2/tests :tree-sitter/tests :ublk/tests :syslog/tests
   :uring/tests :xkb/tests :zstd/tests :chromaprint/tests
   :jack/tests :blas/tests :jpeg/tests :openssl/tests :wasmer/tests :ffmpeg/tests)
